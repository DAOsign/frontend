...
export const networkOptions: Option[] = [
  ...
  { label: "NEAR Testnet", value: 6, icon: NearImg, disabled: false },
  ...
  { label: "SUI Mainnet", value: 7, icon: SUIImg, disabled: true },
  { label: "Polkadot Mainnet", value: 8, icon: PolkadotImg, disabled: true },
];
