...
export type DeleteAgreementMutationMutation = {
  __typename?: "Mutation";
  deleteAgreement: { __typename?: "DeleteAgreementResponse"; agreementId: string; message: string };
};
...
export type SendSignedFileProofDataMutation = {
  __typename?: "Mutation";
  sendSignedFileProofData?: { __typename?: "CID"; cid: string } | null;
};
...
export type SendSignedSignProofDataMutation = {
  __typename?: "Mutation";
...
export type EditObserversMutation = {
  __typename?: "Mutation";
  editObservers?: { __typename?: "SendAgreementInvitationResponse"; message: string } | null;
};
...
export type QueryQuery = {
  ...
  agreement?: {
    __typename?: "Agreement";
    agreementId: string;
    snapshotProposalUrl?: string | null;
    title: string;
    content?: string | null;
    ...
    agreementLocation?: {
      __typename?: "AgreementLocation";
      agreementLocationId: string;
      isActive: boolean;
      name: string;
    } | null;
    agreementPrivacy?: { __typename?: "AgreementPrivacy"; name: string } | null;
    ...
    signProofs?: Array<{
      ...
      signerWallet?: { __typename?: "Wallet"; address: string } | null;
    }> | null;
    agreementFileProof?: {
      __typename?: "AgreementFileProof";
      cid?: string | null;
...
export type GetAgreementFileProofDataQuery = {
  __typename?: "Query";
  getAgreementFileProofData?: {
    __typename?: "AgreementFileProofDataType";
    primaryType: string;
    domain: { __typename?: "TypedDataDomainType"; name: string; version: string };
    types: {
      __typename?: "AgreementFileProofDataTypesType";
      Agreement: Array<{ __typename?: "TypedDataFieldType"; name: string; type: string }>;
      Signers: Array<{ __typename?: "TypedDataFieldType"; name: string; type: string }>;
    };
    message: {
      __typename?: "AgreementFileProofDataMessageType";
      name: string;
...
export type GetAgreementSignProofDataQuery = {
  __typename?: "Query";
  getAgreementSignProofData?: {
    __typename?: "AgreementSignProofDataType";
    primaryType: string;
    domain: { __typename?: "TypedDataDomainType"; name: string; version: string };
    types: {
...
export type GenerateAgreementQuery = {
  __typename?: "Query";
  generateAgreement: { __typename?: "GenerateAgreementResponse"; text: string };
};
...
export type RefineGeneratedAgreementQuery = {
  __typename?: "Query";
  refineGeneratedAgreement: { __typename?: "GenerateAgreementResponse"; text: string };
};
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "snapshotProposalUrl" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "snapshotProposalUrl" },
                value: { kind: "Variable", name: { kind: "Name", value: "snapshotProposalUrl" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
export const DeleteAgreementMutationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteAgreementMutation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "agreementId" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "deleteAgreement" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "agreementId" },
  ...
  DeleteAgreementMutationMutation,
  DeleteAgreementMutationMutationVariables
>;
export const SendSignedFileProofDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "sendSignedFileProofData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AgreementFileProofDataInput" },
            },
          },
        },
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "cid" } }],
            },
          },
        ],
      },
  ...
  SendSignedFileProofDataMutation,
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "sendSignedSignProofData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AgreementSignProofDataInput" },
            },
          },
        },
        {
...
export const VerifyMyEmailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "verifyMyEmail" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "emailVerificationSalt" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "emailVerificationSalt" },
                value: { kind: "Variable", name: { kind: "Name", value: "emailVerificationSalt" } },
              },
              {
                kind: "Argument",
...
} as unknown as DocumentNode<VerifyMyEmailMutation, VerifyMyEmailMutationVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "agreementId" } },
                { kind: "Field", name: { kind: "Name", value: "snapshotProposalUrl" } },
                {
                  kind: "Field",
                  ...
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "agreementFileId" } },
                      { kind: "Field", name: { kind: "Name", value: "agreementHash" } },
                ...
                },
                {
                  ...
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "agreementLocationId" } },
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "observerId" } },
                      {
                        kind: "Field",
                ...
                { kind: "Field", name: { kind: "Name", value: "createdAt" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "signerWalletId" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "signerWallet" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [{ kind: "Field", name: { kind: "Name", value: "address" } }],
                        },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "agreementFileProof" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "cid" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "agreementProof" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "cid" } },
...
export const MyAgreementsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "MyAgreements" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<MyAgreementsQuery, MyAgreementsQueryVariables>;
export const GetAgreementFileProofDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAgreementFileProofData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "agreementId" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "primaryType" } },
                {
                  kind: "Field",
  ...
  GetAgreementFileProofDataQuery,
  GetAgreementFileProofDataQueryVariables
>;
export const GetAgreementSignProofDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAgreementSignProofData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "agreementId" } },
  ...
  GetAgreementSignProofDataQuery,
  GetAgreementSignProofDataQueryVariables
>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "proposalText" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
          },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "legalJurisdictionCountry" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "legalJurisdictionState" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "additionalDetails" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "addIndemnificationClause" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "Boolean" } },
        },
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "addIntellectualPropertyClause" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "Boolean" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "addNonSolicitationClause" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "Boolean" } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "proposalText" },
                value: { kind: "Variable", name: { kind: "Name", value: "proposalText" } },
              },
              {
                kind: "Argument",
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "legalJurisdictionCountry" },
                value: {
                  kind: "Variable",
                  name: { kind: "Name", value: "legalJurisdictionCountry" },
                },
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "legalJurisdictionState" },
                value: {
                  kind: "Variable",
                  name: { kind: "Name", value: "legalJurisdictionState" },
                },
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "additionalDetails" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "addIndemnificationClause" },
                value: {
                  kind: "Variable",
                  name: { kind: "Name", value: "addIndemnificationClause" },
                },
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "addNonSolicitationClause" },
                value: {
                  kind: "Variable",
                  name: { kind: "Name", value: "addNonSolicitationClause" },
                },
...
} as unknown as DocumentNode<GenerateAgreementQuery, GenerateAgreementQueryVariables>;
export const RefineGeneratedAgreementDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "RefineGeneratedAgreement" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "userRequest" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
          },
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "userRequest" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "agreementId" },
...
} as unknown as DocumentNode<RefineGeneratedAgreementQuery, RefineGeneratedAgreementQueryVariables>;
