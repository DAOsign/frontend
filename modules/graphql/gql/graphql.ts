...
export type QueryGenerateAgreementArgs = {
  ...
  legalJurisdictionCountry: Scalars['String'];
...
export const GenerateAgreementDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GenerateAgreement"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"proposalText"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"contractType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"legalJurisdictionCountry"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"legalJurisdictionState"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generateAgreement"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"proposalText"},"value":{"kind":"Variable","name":{"kind":"Name","value":"proposalText"}}},{"kind":"Argument","name":{"kind":"Name","value":"contractType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"contractType"}}},{"kind":"Argument","name":{"kind":"Name","value":"legalJurisdictionCountry"},"value":{"kind":"Variable","name":{"kind":"Name","value":"legalJurisdictionCountry"}}},{"kind":"Argument","name":{"kind":"Name","value":"legalJurisdictionState"},"value":{"kind":"Variable","name":{"kind":"Name","value":"legalJurisdictionState"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"text"}}]}}]}}]} as unknown as DocumentNode<GenerateAgreementQuery, GenerateAgreementQueryVariables>;