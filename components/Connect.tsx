...
export default function Connect() {
  ...
  return (
    <Container sx={{variant: 'cards.connect'}}>
        <Heading sx={{variant: 'text.h2', mb: '40px'}} as='h1'>Connect a Wallet</Heading>
        <Button 
            type="button" 
            onClick={() => connect('injected')} 
            sx={{variant: 'buttons.primary', marginBottom: '12px'}}>
                MetaMask
        </Button>
        <Button 
            type="button" 
        ...
        <Button 
            ...
            sx={{variant: 'buttons.primary', marginBottom: '40px'}}>
                Coinbase Wallet
        </Button>
        <Text
        sx={{variant: 'text.secondary', maxWidth: '220px', display: 'inline-block'}}>
