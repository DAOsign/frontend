...
export function Logo({margin = '0 auto'}) {
  ...
  <div style={{height: '48px', margin: '0 auto 0 0'}}>
    <Flex sx={{justifyContent: 'center' , cursor: 'pointer' }}>
       ...
       <Box sx={{ml: '8px'}}>
         <Flex>
           <Box><Icon width='28px' height='28px' src={iconsObj.dLogo}/></Box>
           <Box><Icon width='28px' height='28px'  src={iconsObj.aLogo}/></Box>
           <Box><Icon width='28px' height='28px'  src={iconsObj.oLogo}/></Box>
         </Flex>
         <Text color="#CA5CF2" sx={{...text, position: 'static', animation: 'unset'} }>sign</Text>
       </Box>
   </Flex>
  </div>
  );
