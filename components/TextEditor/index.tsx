...
const TextEditor = ({valueTextEditor, setvalueTextEditor, cloud, setCloud}: any ) => {
    ...
    <MDEditor 
      ...
      <Flex sx={{backgroundColor: '#EDEDF3', borderRadius: '0 0 8px 8px', height: '32px', alignItems: 'center', pl: '12px'}}> 
        <Icon src={iconsObj.m}/> <Text sx={{variant: 'text.overscript', opacity: 0.5, ml: '4px'}}>Markdown is supported</Text> 
      </Flex>
    </div>
}
